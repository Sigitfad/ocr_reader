...
from PySide6.QtCore import Qt #Qt untuk flag alignment dan lainnya
from PySide6.QtGui import QFont #QFont untuk mengatur font pada widget
from config import JIS_TYPES, DIN_TYPES  #daftar label baterai untuk preset JIS dan DIN


#untuk membuat dan mengembalikan dialog QDialog untuk pengaturan kamera, preset, dan label
#parameter:
...
def create_setting_dialog(parent, camera_combo, preset_combo, jis_type_combo, available_cameras):
    ...
    #style css yang digunakan pada GroupBox dan ComboBox
    group_style = """
        QGroupBox {
    ...
    #untuk perbarui isi combo label di dialog saat preset berubah
    ...
    #tombol "SAVE SETTING" untuk menyimpan semua pilihan ke MainWindow dan menutup dialog
    ...
    #untuk terapkan semua perubahan setting ke MainWindow saat tombol SAVE diklik
    def save_settings():
