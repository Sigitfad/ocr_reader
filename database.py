...
# Fungsi: inisialisasi database, membuat tabel jika belum ada,
...
# Fungsi: mengambil semua data deteksi untuk tanggal tertentu dari database
...
# Fungsi: menghapus record dari database berdasarkan daftar ID,
# sekaligus menghapus file gambar yang terkait dari disk
...
# Fungsi: menyimpan satu hasil deteksi baru ke database
...
# Fungsi: menghitung total jumlah record di database (opsional: bisa pakai db_file berbeda)
