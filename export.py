...
def execute_export(sql_filter="", date_range_desc="", export_label="", current_preset="", progress_callback=None):
    ...
    try:
        ...
        # ── Tulis Info Header di Baris 1-6 ────────────────────────────────────
        ...
        # Tulis nama kolom (header tabel) pada baris ke-7 dengan format header biru
        ...
        # ── Tulis Setiap Baris Data + Sisipkan Gambar ─────────────────────────
        ...
        for row_num, row_data in df.iterrows():
            ...
            if os.path.exists(image_path):
                ...
                # Nama file thumbnail unik berdasarkan PID proses dan nomor baris
            ...
            worksheet.write(excel_row, 6, row_data['Image Path'], cell_format)    # Kolom tersembunyi
            worksheet.write(excel_row, 7, row_data['Target Session'], cell_format) # Kolom tersembunyi
