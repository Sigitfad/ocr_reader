...
def execute_export(sql_filter="", date_range_desc="", export_label="", current_preset="", progress_callback=None):
    ...
    try:
        ...
        #Define format untuk "Not OK" rows (red background): Background merah, text putih untuk highlight error
